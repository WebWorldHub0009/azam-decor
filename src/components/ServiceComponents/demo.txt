...
const serviceDetails = {
  ...
  2: {
    title: "CEILING PANEL",
    description:
      "Ceiling panels are high-quality exterior or interior wall coverings designed to protect and enhance the appearance of buildings. They are durable, weather-resistant, and low-maintenance, providing excellent insulation and soundproofing. Available in a variety of materials, textures, and finishes, cladding panels offer aesthetic appeal while safeguarding structures from environmental damage. Ideal for homes, offices, and commercial spaces, they combine functionality with style, delivering long-lasting protection and a modern, polished look.",
    images: [
...
export default function ServiceDetail() {
  ...
  return (
    <div className="max-w-5xl mx-auto px-4 py-12 mt-24">
      {/* Heading */}
      <h1 className="text-4xl font-bold text-center text-[#D99021] mb-6">
        {service.title}
      </h1>

      {/* Description */}
      <p className="text-center text-gray-600 mb-12">{service.description}</p>
      ...
      <div className="flex justify-center mt-12">
        <button
          onClick={() => navigate(-1)}
          className="px-6 py-3 bg-[#172D20] text-[#D99021] font-semibold rounded hover:bg-[#D99021] hover:text-[#171512] transition"
        >
          Back
        </button>
      </div>
