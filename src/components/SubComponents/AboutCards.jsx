  ...
  return (
    <section id="about" className="py-5 bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 md:px-8 flex flex-col md:flex-row items-center gap-10">
        ...
        {/* Right Content */}
        <div className="md:w-1/2 flex flex-col justify-center py-0">
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-8 mt-16 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8 ">
        {aboutCards.map((card, idx) => (
          <div
            key={idx}
            className="bg-white rounded-xl p-6 shadow-lg flex flex-col items-center text-center hover:shadow-2xl transition-shadow duration-300  hover:bg-[#D99021]  hover:text-[#000000] "
          >
            {card.icon}
